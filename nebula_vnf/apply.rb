...
=end
        ...
        FORMAT="qcow2"
        DEV_PREFIX="vd"
        SOURCE="/var/lib/one/datastores/img/service_vnf.qcow2"
        SIZE="20480"
        CONTENTS
...
class Vnf < One
    ...
    def ensure_template(name)
        ...
        CONTEXT = [
          ...
          ONEAPP_VNF_HAPROXY_ONEGATE_ENABLED = "$ONEAPP_VNF_HAPROXY_ONEGATE_ENABLED",
          ...
          #ONEAPP_VNF_HAPROXY_LB0_IP = "0.0.0.0",
          #ONEAPP_VNF_HAPROXY_LB0_PORT = "8686",
        ...
        USER_INPUTS = [
          ...
          ONEAPP_VROUTER_ETH0_VIP0 = "O|text|ONEAPP_VROUTER_ETH0_VIP0||10.2.11.86",
          ONEAPP_VNF_HAPROXY_ENABLED = "O|boolean|ONEAPP_VNF_HAPROXY_ENABLED||YES",
          ONEAPP_VNF_HAPROXY_ONEGATE_ENABLED = "O|boolean|ONEAPP_VNF_HAPROXY_ONEGATE_ENABLED||NO",
          ONEAPP_VNF_HAPROXY_INTERFACES = "O|text|ONEAPP_VNF_HAPROXY_INTERFACES||eth0",
          ONEAPP_VNF_HAPROXY_REFRESH_RATE = "O|text|ONEAPP_VNF_HAPROXY_REFRESH_RATE||30",
          ONEAPP_VNF_HAPROXY_CONFIG = "O|text|ONEAPP_VNF_HAPROXY_CONFIG||" ]
...
if caller.empty?
    ...
    svc.ensure_service_template 'vnf', {
        vnf: vnf_template.id,
    }
end
